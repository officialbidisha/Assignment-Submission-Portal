            ...
            <div class="login-form">
             <form action="" method="post">
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" name="id" value="" class="form-control" placeholder="Teacher Id" required/>
                  </div>
                  <div class="form-group">
                                ...
                                if($data=mysqli_query($con,$query)){?>
                                    <div class="p-2"></div>
                                                ...
                                                <div class="d-flex justify-content-center alert alert-danger" style="width:30%">
                                                    <?php echo "Successfully Registered";header( "refresh:2; url=login_teacher.php" );?>
                                                </div>
                                                </div>
                                        <?php }
                                else{
