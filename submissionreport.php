      ...
      <form action="" method="post">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="number" name="number" value="<?php echo $_POST["number"]; ?>" class="form-control" id="assignmentNo" aria-describedby="assignmentNoHelp" placeholder="Enter Assignment Number" required>
          </div>
          </div>
          </div><!---end------>   
          <div class="p-2"></div>
                        ...
                        ?>
                                <tbody class="table-design">
                                       <tr>
                                            ...
                                            <td><a href="<?php echo $result['link']; ?>" target="_blank">Click Here</a></td>
