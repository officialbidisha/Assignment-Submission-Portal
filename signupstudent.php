...
<div class="sidenav">
         <div class="login-main-text">
            <h2>Student<br> Registration Page</h2>
            ...
            <div class="login-form">
             <form action="" method="post">
                  ...
                  <div class="form-group">
                     ...
                     <input type="number" name="id" value="" class="form-control" placeholder="Registration Number" required/>
                  </div>
                  <div class="form-group">
                     <label>Semester</label>
                     <input type="number" name="sem" value="" class="form-control" placeholder="Semester Number"/>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                     ...
                     <input type="password" name="conpwd" value="" class="form-control" placeholder="Password">
                  </div>
               ...
               <?php
                            ...
                            if(isset($_POST['submit']))
                            {
                                ...
                                if($pwd==$conpwd)
                                {
                                    $query="INSERT INTO student values($id,'$name','$pwd',$sem)";
